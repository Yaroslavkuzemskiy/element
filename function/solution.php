<?php 
add_action( 'init', 'register_solution' );
function register_solution(){
	register_post_type('solution', array(
		'label'  => null,
		'labels' => array(
			'name'               => 'Solution', // основное название для типа записи
			'singular_name'      => 'Solution', // название для одной записи этого типа
			...
			'menu_name'          => 'Solution', // название меню
